...
KERBEROS_REALM=${KERBEROS_REALM:=DEMO.PLATFORMPROVIDER.COM}
KERBEROS_KDC_HOST=${KERBEROS_KDC_HOST:=idp.integration.labs.platformprovider.com:88}
KERBEROS_KADMIN_HOST=${KERBEROS_KADMIN_HOST:=idp.integration.labs.platformprovider.com:749}
...
'RULE:[1:$1@$0](.*@DEMO.PLATFORMPROVIDER.COM)s/@DEMO.PLATFORMPROVIDER.COM//
RULE:[2:$1@$0](.*@DEMO.PLATFORMPROVIDER.COM)s/@DEMO.PLATFORMPROVIDER.COM//
DEFAULT'
EOM
...
cat << EOF > request.json
{
  ...
  "mainClass" : "com.platformprovider.gosec.job.BypassJob",
  "sparkProperties" : {
    ...
    "spark.mesos.executor.docker.image" : "qa.platformprovider.com/platformprovider/spark-krb-dispatcher-support:2.1.0",
    ...
    "spark.cores.max" : "${SPARK_MAX_CORES:=3}",
